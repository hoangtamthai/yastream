...
import { RATE_LIMIT_DESCRIPTION, TICKCOUNTER_HOST } from "../utils/constant.js";
...
class KissKHScraperr extends BaseProvider {
  ...
  private nsfwIds = new Set([
    13797, 13771, 13757, 13756, 13711, 13690, 13657, 13639, 13616, 13596, 13449,
    13398, 13377, 13373, 13372, 13370, 13446, 13399, 13371, 13306, 13295, 13286,
    13265, 13234, 13224, 13157, 13118, 13117, 13114, 13100, 13092, 13085, 13073,
    13055, 13054, 13048, 13041, 13030, 12977, 12934, 12939, 12938, 12937, 12936,
    12935, 12929, 12928, 12886, 12891, 12887, 12893, 12890, 12889, 12888, 12809,
    12808, 12662, 12660, 12639, 12563, 12519, 12518, 12517, 12516, 12515, 12514,
    12513, 12510, 12504, 12503, 12495, 12491, 12482, 12480, 12413, 12378, 12332,
    12331, 12330, 12314, 12286, 12285, 12284, 12200, 12179, 12177, 12131, 12130,
    12129, 12127, 12125, 12124, 12123, 12121, 12100, 12106, 12097, 12090, 11952,
    11951, 11943, 11915, 11873, 11849, 11834, 11832, 11819, 11790, 11782, 11781,
    11750, 11715, 11707, 11544, 11519, 11518, 11517, 11511, 11509, 11436, 10942,
    10761, 7968,
  ]);
  ...
  async generateStreamsAndSubtitles(
    ...
    if (url.includes(TICKCOUNTER_HOST)) return [];
